...
function Homepage() {
    ...
    <div className="story-home-container container d-flex align-items-center w-75 py-5">
        <div className="story-home-content row">
        <div className="col-md-5 d-flex flex-column justify-content-center text-start mb-4" data-aos="fade-up" data-aos-duration="1500">
        ...
        <div className="col-md-7" style={{ height: "100%" }} data-aos="fade-up" data-aos-duration="1500">
